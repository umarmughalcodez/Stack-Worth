  ...
  return (
    <div className="gap-10 flex flex-wrap items-center justify-center m-0 p-0">
      {options.map((option) => (
        <label
          key={option.value}
          className={`flex flex-col text-center items-center justify-center gap-1 h-40 border rounded-lg  transition-all delay-100 active:scale-75 w-44 border-none ${
